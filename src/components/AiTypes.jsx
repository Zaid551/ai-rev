const AiTypes = () => {
  const aiTypes = [
    ...
    },
    {
      ...
      tags: [
        { text: "Chat bots", color: "secondary" },
  ...
  return (
    <section id="types" className="app-container py-16 overflow-hidden sm:overflow-visible">
      <div className="text-center mb-12">
        ...
        <p className="section-description">Explore the diverse landscape of AI technologies that are shaping our future.</p>
      </div>
          ...
          <article key={type.title}  className="ai-type-card">
            ...
            <div className="p-6">
              ...
              <div className="mt-4 flex items-center gap-x-2">
                {type.tags.map((tag)=>(
                  <span key={tag.text} className={`ai-type-card-tag ${tagColors[tag.color]}`}>{tag.text}</span>
                ))}
              </div>
            </div>
          </article>
