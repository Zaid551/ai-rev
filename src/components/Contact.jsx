    ...
    <section id="contact" className="app-container py-16">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <div>
          ...
          <p className="section-description">Our team of AI experts is ready to help you implement cutting-edge solutions tailored to your specific needs. Contact us today to schedule a consultation.</p>
          <div className="mt-4 space-y-4">
            {contactDetails.map((detail, i) => (
              <div key={i} className="contact-into-group">
                <div className="form-icon bg-primary/10 text-primary">
                  {detail.icon}
                </div>
                <div>
        ...
        <div className="bg-white rounded-xl shadow-lg p-6 lg:p-8">
          <form action="">
            <div className="space-y-6">
              <div>
                <label htmlFor="fullName" className="form-input-label">Full Name</label>
                <input type="text" id="fullName" className="form-input"/>
              </div>
              <div>
                <label htmlFor="emailAddress" className="form-input-label">Email Address</label>
              ...
              <div>
                ...
                <textarea rows={4} id="message" className="form-input"/>
              </div>
            </div>
            <button className="btn-primary w-full mt-6">Send</button>
          </form>
        </div>
      </div>
    </section>
